...
function Open({ children, opens: opensWidnowName }) {
  const { open } = useContext(ModalContext);

  return cloneElement(children, { onClick: () => open(opensWidnowName) });
}
...
function Window({ children, name }) {
  ...
  return createPortal(
    //Another way to click outside of the modal is to set <Overlay onClick={close}>. No need for the useEffect above.
    <Overlay>
      <StyledModal ref={ref}>
